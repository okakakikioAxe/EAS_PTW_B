...
<head>
    ...
    <!-- template-->
    <link href="{{ asset('css/styleprofil.css') }}" rel="stylesheet" type="text/css">
    <link
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-warning sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-icon">
                    <i class="fas fa-feather-alt text-succes me-2"></i>
                </div>
                <div class="sidebar-brand-text mx-3 text-dark">Fesien</div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="copyright text-center text-dark btn-warning p-2">
